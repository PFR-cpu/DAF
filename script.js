...
function checkAns(){
    ...
    if(questcount == 1){
        question.innerHTML = 'Вы хотели бы участвовать в интересных крипто активностях и наращивать свой капитал без вложений?'
        question.style.fontSize = '1.4vw';
    }
    if(questcount == 2){
    ...
    if(questcount == 3){
        ...
        question.style.fontSize ='5.8vw'
        if(window.innerWidth < 768){
            question.style.fontSize ='1.9vw'
        }
    }
}
